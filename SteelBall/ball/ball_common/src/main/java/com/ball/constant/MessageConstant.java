...
public class MessageConstant {
    ...
    public static final String DELETE_DATA_SUCCESS = "删除数据成功";
    public static final String ADD_DATA_SUCCESS = "新增数据成功";
    public static final String ADD_DATA_FAIL = "新增数据失败";
    public static final String EDIT_DATA_FAIL = "编辑数据失败";
    public static final String EDIT_DATA_SUCCESS = "编辑数据成功";
    public static final String QUERY_DATA_SUCCESS = "查询数据成功";
